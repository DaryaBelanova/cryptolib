#ifndef REFERENCEIMPLEMENTATIONS_MAGMANULLCMAC8_H
#define REFERENCEIMPLEMENTATIONS_MAGMANULLCMAC8_H
...
namespace Crisp {
	...
	class MagmaNullCMAC8 : public Crisp::CrispSuite {
...
#endif //REFERENCEIMPLEMENTATIONS_MAGMANULLCMAC8_H