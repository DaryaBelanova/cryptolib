#ifndef REFERENCEIMPLEMENTATIONS_MAGMACTRCMAC_H
#define REFERENCEIMPLEMENTATIONS_MAGMACTRCMAC_H
...
namespace Crisp {
	...
	class MagmaCTRCMAC : public Crisp::CrispSuite {
...
#endif //REFERENCEIMPLEMENTATIONS_MAGMACTRCMAC_H