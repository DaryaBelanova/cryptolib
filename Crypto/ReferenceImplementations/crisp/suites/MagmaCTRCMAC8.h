#ifndef REFERENCEIMPLEMENTATIONS_MAGMACTRCMAC8_H
#define REFERENCEIMPLEMENTATIONS_MAGMACTRCMAC8_H
...
namespace Crisp {
	...
	class MagmaCTRCMAC8 : public Crisp::CrispSuite {
...
#endif //REFERENCEIMPLEMENTATIONS_MAGMACTRCMAC8_H